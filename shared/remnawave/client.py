...
class RemnawaveClient:
    ...
    # Значение по умолчанию на классе: клиент остаётся рабочим, даже если
    # экземпляр собран в обход __init__ (так делают подмены в тестах).
    _access_params: dict[str, str] = {}
